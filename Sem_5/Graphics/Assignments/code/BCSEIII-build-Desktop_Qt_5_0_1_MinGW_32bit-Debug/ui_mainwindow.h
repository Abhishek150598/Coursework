...
"background-color: rgb(85, 255, 255);"));
        ...
        Draw->setGeometry(QRect(590, 400, 81, 31));
        ...
        parametric = new QRadioButton(centralWidget);
        parametric->setObjectName(QStringLiteral("parametric"));
        parametric->setGeometry(QRect(590, 330, 82, 17));
        dda = new QRadioButton(centralWidget);
        dda->setObjectName(QStringLiteral("dda"));
        dda->setGeometry(QRect(590, 350, 82, 17));
        bresenham = new QRadioButton(centralWidget);
        bresenham->setObjectName(QStringLiteral("bresenham"));
        bresenham->setGeometry(QRect(590, 370, 82, 17));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        parametric->setText(QApplication::translate("MainWindow", "Parametric", 0));
        dda->setText(QApplication::translate("MainWindow", "DDA", 0));
        bresenham->setText(QApplication::translate("MainWindow", "Bresenham", 0));
    } // retranslateUi
